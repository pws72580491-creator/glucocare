# 글루코케어 Pro (GlucoCare Pro) — v1.6.0
...
unzip ../glucocare-pro-v1_6_0.zip
...
- GL(혈당부하) 자동 계산 — GI × 탄수화물(g) ÷ 100. 기록 목록·식단 입력 화면·리포트 평균·CSV에 표시됩니다 (낮음/보통/높음 분류, 새 입력 필드 없이 이미 저장된 GI·탄수화물 값에서 계산)
